...
spec.subspec 'CsjAdapter' do |ss|
     ...
     #ss.dependency 'Ads-CN-Beta','>= 7.1.0.0', :subspecs => ['BUAdSDK', 'CSJMediation']
...
spec.subspec 'QuMengAdapter' do |ss|
  ...
  spec.subspec 'ZJAdapter' do |ss|
     ...
     ss.dependency 'ZJSDK/ZJSDKModuleDSP','>= 2.5.9.18'
     ss.dependency 'ZJSDK/ZJSDKModuleKSCompatible'
    ...
    spec.subspec 'TakuAdapter' do |ss|
     ...
     ss.dependency 'AnyThinkiOS','>= 6.4.75'
        ...
        spec.subspec 'BwtAdapter' do |ss|
     ss.dependency 'OpenAdSDK/OpenAdSDK'
     ss.ios.deployment_target = '11.0'
     ss.vendored_frameworks = 'OpenAdSDK/OpenAdCxhAdapter.framework'
     ss.dependency 'CXHAdSDK/Channel'
          ss.dependency 'CXHAdSDK/RC'
  end
  
      spec.subspec 'SigmobAdapter' do |ss|
     ss.dependency 'OpenAdSDK/OpenAdSDK'
     ss.ios.deployment_target = '11.0'
     ss.vendored_frameworks = 'OpenAdSDK/OpenAdSigmobAdapter.framework'
